...
const Card = ({ vacation }) => {
  return (
    <div className='bg-white shadow-lg hover:shadow-2xl transition-all hover:scale-105 rounded-lg max-w-xs overflow-hidden mx-2'>
      <div className=''>
        <img
      ...
      <div className='p-4'>
        ...
        <div className='flex items-end justify-between pt-3'>
          ...
          <span className=' text-gray-600 text-sm'>
            {vacation.followers ? vacation.followers : 0} followers
          </span>
        </div>
      </div>
    </div>
